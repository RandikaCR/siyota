...
@php
    $breadcrumbTitle = $machinery->machinery;
@endphp

@section('meta_info')
    @php
        $metaTitle = $machinery->machinery . ' - Siyota (Pvt) Ltd. Official Website';
        $metaDescription = '';
        $metaKeywords = '';
        $metaImage = '';
        $metaUrl = '';
...
@section('content')
        ...
        <div class="row ">
            ...
            <div class="col-md-6 pt-md-0 pt-10">
                {{--<p class="d-flex align-items-center mb-6">
                    <span class="fs-18px text-body-emphasis ps-6 fw-bold" id="price-area">{{ priceWithCurrency($machinery->default_price) }}</span>
                </p>--}}
                <h1 class="mb-4 pb-2 fs-4">{{ $machinery->machinery }}</h1>

                <div class="row mt-10">
                    @if(!$machinery->machinery_labels->isEmpty())
                        <div class="col-sm-12 form-group">
                            {{--<label class="text-body-emphasis fw-semibold py-5" for="quantity">Labels: </label>--}}
                            <ul>
                                @foreach($machinery->machinery_labels as $lb)
                ...
                @if(!empty(strip_tags($machinery->description)))
                    <div class="mt-11">
                        <div class="row">
                            <div class="col-sm-12">
                                <h5 class="mb-5">Machinery Description</h5>
    ...
    @if(!empty(count($related_machineries)))
        <section class="container pt-15 pb-15 pt-lg-17 pb-lg-20">
            ...
            <div class="slick-slider" data-slick-options="{&#34;arrows&#34;:true,&#34;centerMode&#34;:true,&#34;centerPadding&#34;:&#34;calc((100% - 1440px) / 2)&#34;,&#34;dots&#34;:true,&#34;infinite&#34;:true,&#34;responsive&#34;:[{&#34;breakpoint&#34;:1200,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:3}},{&#34;breakpoint&#34;:992,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:2}},{&#34;breakpoint&#34;:576,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:1}}],&#34;slidesToShow&#34;:4}">
                ...
                @foreach($related_machineries as $rel)
                    <div class="mb-6">
                        <div class="card card-product grid-2 bg-transparent border-0">
                            <figure class="card-img-top position-relative mb-7 overflow-hidden">
                                <a href="{{ url('/machinery/' . $rel->slug) }}" class="hover-zoom-in d-block" title="Shield Conditioner">
                                ...
                                <a href="{{ url('/machinery/' . $rel->slug) }}" class="btn btn-add-to-cart btn-dark btn-hover-bg-primary btn-hover-border-primary position-absolute z-index-2 text-nowrap">View</a>
                            </figure>
                            <div class="card-body text-center p-0">
                                ...
                                <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3"><a class="text-decoration-none text-reset" href="{{ url('/machinery/' . $rel->slug) }}">{{ $rel->machinery }}</a></h4>
                            </div>
                        </div>
    ...
    <input type="hidden" id="machinery_id" value="{{ $machinery->id }}">
@endsection
    ...
    <script>
        ...
        $(document).ready(function (){
            $('.get-price').on('click', function ($e){
                ...
                $machineryId = $('#machinery_id').val();
                $labelId = $('#label_id').val();

                $.ajax({
                    url: "{{ route('frontend.machineries.getPricingDetails') }}",
                    type: 'POST',
                    data: {
