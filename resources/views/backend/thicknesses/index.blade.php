...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">All Product Thicknesses</h4>
                                    ...
                                    <table class="table table-hover table-striped align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 60%;">
                                                <p class="mb-0">Product Thickness</p>
                                            </th>
                                            <th class="text-center" scope="col">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1"><span class="me-1">Create New</span><span>Product Thickness</span></h4>
                    <div class="flex-shrink-0">
                    </div>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 mb-2">
                            <div>
                                <label for="name-input" class="form-label">Product Thickness*</label>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-sm-12 d-flex justify-content-end">
                            ...
                            <a href="{{ url('/admin/thicknesses') }}" class="btn btn-outline-dark waves-effect waves-light me-2"><i class="mdi mdi-restore me-1"></i>Reset</a>
    ...
    <script>
        $(document).ready(function (){
            $('.save-this-form').on('click', function (){
                ...
                $url = "{{ route('backend.thicknesses.store') }}";
            ...
            $('.table').on('click', '.edit', function (){
                $id = $(this).data('id');
                $url = "{{ route('backend.thicknesses.get') }}";
                $.ajax({
                    url: $url,
                    dataType: 'json',
                    data: {
            ...
            $('.table').on('change', '.status', function (){
                $id = $(this).data('id');
                $url = "{{ route('backend.thicknesses.status') }}";
                $rowId = '#row-' + $id;
                $.ajax({
                    url: $url,
                    dataType: 'json',
