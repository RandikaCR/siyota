...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">All Machinery Categories</h4>
                                    ...
                                    <table class="table table-hover table-striped align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 50%;">
                                                <p class="mb-0">Machinery Category</p>
                                            </th>
                                            <th class="text-center" scope="col">
                                        ...
                                        @foreach($categories as $category)
                                            <tr id="row-{{ $category->id }}">
                                                ...
                                                <td>
                                                    <p class="mb-0">{{ $category->machinery_category }}</p>
                                                </td>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1"><span class="me-1">Create New</span><span>Machinery Category</span></h4>
                    <div class="flex-shrink-0">
                    </div>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 mb-2">
                            <div>
                                <label for="category-input" class="form-label">Machinery Category Name*</label>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-sm-12 d-flex justify-content-end">
                            ...
                            <a href="{{ url('/admin/machinery-categories') }}" class="btn btn-outline-dark waves-effect waves-light me-2"><i class="mdi mdi-restore me-1"></i>Reset</a>
    ...
    <script>
        $(document).ready(function (){
            $('.save-this-form').on('click', function (){
                ...
                $url = "{{ route('backend.machineryCategories.store') }}";
            ...
            $('#category-input').on('blur', function ($e){
                ...
                $url = "{{ route('backend.machineryCategories.slugGenerator') }}";
            ...
            $('.table').on('click', '.edit', function (){
                $id = $(this).data('id');
                $url = "{{ route('backend.machineryCategories.get') }}";
                $.ajax({
                    url: $url,
                    dataType: 'json',
                    data: {
                    ...
                    success: function ($res, $textStatus, $jqXHR) {
                        $('#edit-id').val($res.id);
                        $('#category-input').val($res.machinery_category);
            ...
            $('.table').on('change', '.status', function (){
                $id = $(this).data('id');
                $url = "{{ route('backend.machineryCategories.status') }}";
                $rowId = '#row-' + $id;
                $.ajax({
                    url: $url,
                    dataType: 'json',
