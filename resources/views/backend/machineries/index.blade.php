    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Machineries</h4>
...
@section('header_buttons')
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-end mb-3">
            <a href="{{ url('admin/machineries/create') }}" class="btn btn-primary">
                    ...
                    <form method="GET" action="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 d-flex align-items-end">
                                ...
                                <a href="{{ url('admin/machineries') }}" class="btn btn-outline-dark waves-effect waves-light ms-2">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">All Machineries</h4>
                ...
                <div class="card-body">
                    <div class="live-preview">
                                ...
                                <div class="table-responsive mt-4 mt-xl-0">
                                    <table class="table table-hover table-striped align-middle table-nowrap mb-0">
                                        ...
                                        @foreach($machineries as $machinery)
                                            <tr id="row-{{ $machinery->id }}">
                                                <td class="fw-medium text-center">
                                                    <p class="mb-0">{{ $machinery->id }}</p>
                                                </td>
                                                <td>
                                                    <div class="bg-light rounded p-1">
                                                        <img src="{{ asset('assets/common/images/uploads/' .$machinery->primary_image) }}" class="img-fluid d-block" alt="Img">
                                                    </div>
                                                </td>
                                                <td>
                                                    <p class="mb-0">{{ $machinery->machinery }}</p>
                                                </td>
                                                ...
                                                <td class="text-end">
                                                    <div class="d-flex justify-content-end align-items-center">
                                                        <div class="form-check form-switch form-switch-success form-switch-md">
                                                            <input class="form-check-input status" data-id="{{ $machinery->id }}" type="checkbox" role="switch"  {{ ($machinery->status == 1) ? 'checked': '' }} >
                                                        </div>
                                                        <div>
                                                            <a href="{{ url('machineries/' . $machinery->slug) }}" target="_blank" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><span class="mdi mdi-magnify"></span></a>
                                                            <a href="{{ route('backend.machineries.edit', $machinery->uuid) }}" class="btn btn-primary btn-sm waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="mdi mdi-pencil"></span></a>
                                                            <a href="javascript:void(0);" class="btn btn-danger btn-sm waves-effect waves-light delete" data-id="{{ $machinery->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="mdi mdi-delete"></span></a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <div class="mt-5">
                            {{--Paginaiton--}}
                            {!! $machineries->links('vendor.pagination.backend') !!}
                        </div>
                    </div>
                </div><!-- end card-body -->
            </div><!-- end card -->
    ...
    <script>
        $(document).ready(function (){
            ...
            $('.table').on('click', '.delete', function ($e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        setTimeout(function() {
                            $.ajax({
                                url: "{{ route('backend.machineries.delete') }}",
                                type: 'POST',
                                data: {
                                    id: $id,
                                    _token: csrf_token()
                                ...
                                success: function ($response, $textStatus, $jqXHR) {
                                    Swal.fire('Done!', 'Machinery has been deleted!', 'success');
            ...
            $('.table').on('change', '.status', function (){
                $id = $(this).data('id');
                $url = "{{ route('backend.machineries.status') }}";
                $rowId = '#row-' + $id;
                $.ajax({
                    url: $url,
                    dataType: 'json',
