  ...
  APP.colorModes = {
    ...
    colorModes: function () {
      ...
      const e = localStorage.getItem("theme"),
            t = () => e ? e : window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "dark",
            n = function (e) {
        e === "auto" && window.matchMedia("(prefers-color-scheme: dark)").matches ? document.documentElement.setAttribute("data-bs-theme", "dark") : (e === "auto" && (e = "dark"), document.documentElement.setAttribute("data-bs-theme", e));
      };
